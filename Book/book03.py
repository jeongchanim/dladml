# -*- coding: utf-8 -*-
"""
Created on Fri Oct 21 15:31:23 2022

@author: MYCOM

형태소분석기 설치 방법 (관리자 모드로 실행)
...
# 워드 클라우드 표시
wordcloud = WordCloud(font_path = 'HANYGO230.ttf', relative_scaling = 0.5, background_color = 'white')
